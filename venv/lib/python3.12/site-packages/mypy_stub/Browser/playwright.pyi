...
def spawn_wrapper_process(node_executable: str | Path, script: Path, cwd: Path, logfile: TextIO, host: str, port: str, enable_playwright_debug: PlaywrightLogTypes | bool, coverage_output: Path | None = None) -> Popen: ...
