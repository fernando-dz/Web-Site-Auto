...
function createBaseRequest_ElementSelectorWithTextType() {
  return { selector: "", strict: false, textType: "" };
}
var Request_ElementSelectorWithTextType = {
  encode(message, writer = new import_wire.BinaryWriter()) {
    if (message.selector !== "") {
      writer.uint32(10).string(message.selector);
    }
    ...
    if (message.textType !== "") {
      writer.uint32(26).string(message.textType);
    }
    return writer;
  },
  decode(input, length) {
    const reader = input instanceof import_wire.BinaryReader ? input : new import_wire.BinaryReader(input);
    const end = length === void 0 ? reader.len : reader.pos + length;
    const message = createBaseRequest_ElementSelectorWithTextType();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object) {
    return {
      selector: isSet(object.selector) ? globalThis.String(object.selector) : "",
      strict: isSet(object.strict) ? globalThis.Boolean(object.strict) : false,
      textType: isSet(object.textType) ? globalThis.String(object.textType) : ""
    };
  },
  toJSON(message) {
    const obj = {};
  ...
  create(base) {
    return Request_ElementSelectorWithTextType.fromPartial(base ?? {});
  },
  fromPartial(object) {
    const message = createBaseRequest_ElementSelectorWithTextType();
    message.selector = object.selector ?? "";
...
function createBaseRequest_CreateCredential() {
  return { rpId: "", id: "", privateKey: "", publicKey: "", userHandle: "" };
}
var Request_CreateCredential = {
  encode(message, writer = new import_wire.BinaryWriter()) {
    if (message.rpId !== "") {
    ...
    if (message.userHandle !== "") {
      writer.uint32(42).string(message.userHandle);
    }
    return writer;
  },
  decode(input, length) {
    const reader = input instanceof import_wire.BinaryReader ? input : new import_wire.BinaryReader(input);
    const end = length === void 0 ? reader.len : reader.pos + length;
    const message = createBaseRequest_CreateCredential();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object) {
    return {
      ...
      userHandle: isSet(object.userHandle) ? globalThis.String(object.userHandle) : ""
    };
  },
  toJSON(message) {
    const obj = {};
    ...
    if (message.userHandle !== "") {
      obj.userHandle = message.userHandle;
    }
    return obj;
  },
  create(base) {
    return Request_CreateCredential.fromPartial(base ?? {});
  },
  fromPartial(object) {
    const message = createBaseRequest_CreateCredential();
...
function createBaseRequest_CredentialIdAndRpId() {
  return { id: "", rpId: "" };
}
var Request_CredentialIdAndRpId = {
  encode(message, writer = new import_wire.BinaryWriter()) {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    }
  ...
  decode(input, length) {
    const reader = input instanceof import_wire.BinaryReader ? input : new import_wire.BinaryReader(input);
    const end = length === void 0 ? reader.len : reader.pos + length;
    const message = createBaseRequest_CredentialIdAndRpId();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  create(base) {
    return Request_CredentialIdAndRpId.fromPartial(base ?? {});
  },
  fromPartial(object) {
    const message = createBaseRequest_CredentialIdAndRpId();
    message.id = object.id ?? "";
...
function createBaseResponse_GetCredential() {
  return { id: "", rpId: "", userHandle: "", privateKey: "", publicKey: "", log: "" };
}
var Response_GetCredential = {
  encode(message, writer = new import_wire.BinaryWriter()) {
    if (message.id !== "") {
      writer.uint32(10).string(message.id);
    }
    ...
    if (message.userHandle !== "") {
      writer.uint32(26).string(message.userHandle);
    }
    if (message.privateKey !== "") {
  ...
  decode(input, length) {
    const reader = input instanceof import_wire.BinaryReader ? input : new import_wire.BinaryReader(input);
    const end = length === void 0 ? reader.len : reader.pos + length;
    const message = createBaseResponse_GetCredential();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  create(base) {
    return Response_GetCredential.fromPartial(base ?? {});
  },
  fromPartial(object) {
    const message = createBaseResponse_GetCredential();
    message.id = object.id ?? "";
...
var PlaywrightService = {
  ...
  getText: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value) => Buffer.from(Request_ElementSelectorWithTextType.encode(value).finish()),
    requestDeserialize: (value) => Request_ElementSelectorWithTextType.decode(value),
  ...
  /** Credential */
  createCredential: {
    path: "/Playwright/CreateCredential",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value) => Buffer.from(Request_CreateCredential.encode(value).finish()),
    requestDeserialize: (value) => Request_CreateCredential.decode(value),
    responseSerialize: (value) => Buffer.from(Response_Empty.encode(value).finish()),
    responseDeserialize: (value) => Response_Empty.decode(value)
  },
  installCredential: {
    path: "/Playwright/InstallCredential",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value) => Buffer.from(Request_Empty.encode(value).finish()),
    requestDeserialize: (value) => Request_Empty.decode(value),
  ...
  getCredential: {
    path: "/Playwright/GetCredential",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value) => Buffer.from(Request_CredentialIdAndRpId.encode(value).finish()),
    requestDeserialize: (value) => Request_CredentialIdAndRpId.decode(value),
    responseSerialize: (value) => Buffer.from(Response_GetCredential.encode(value).finish()),
    responseDeserialize: (value) => Response_GetCredential.decode(value)
  },
  deleteCredential: {
    path: "/Playwright/DeleteCredential",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value) => Buffer.from(Request_CredentialIdAndRpId.encode(value).finish()),
    requestDeserialize: (value) => Request_CredentialIdAndRpId.decode(value),
...
function listStringResponse(body, logMessage) {
...
async function createCredential(request, context) {
...
async function getCredential(request, context) {
...
async function deleteCredential(request, context) {
...
var TextType = /* @__PURE__ */ ((TextType2) => {
  TextType2["allInnerTexts"] = "allInnerTexts";
  TextType2["allTextContents"] = "allTextContents";
  TextType2["innerText"] = "innerText";
  TextType2["inputValue"] = "inputValue";
  TextType2["innerHTML"] = "innerHTML";
  TextType2["ROBOT_FRAMEWORK_BROWSER_NO_SET"] = "ROBOT_FRAMEWORK_BROWSER_NO_SET";
  return TextType2;
})(TextType || {});
async function _getTextContentNoTextType(locator) {
...
async function getTextContent(locator, textType) {
  logger.info(`Getting text content with text type ${textType}`);
  switch (textType) {
    case "ROBOT_FRAMEWORK_BROWSER_NO_SET" /* ROBOT_FRAMEWORK_BROWSER_NO_SET */:
      return await _getTextContentNoTextType(locator);
    case "allInnerTexts" /* allInnerTexts */:
      logger.info(`Getting allInnerTexts`);
      return await locator.allInnerTexts();
    case "allTextContents" /* allTextContents */:
...
async function getText(request, state) {
  ...
  let content;
  const textTypeEnum = TextType[textType];
  try {
  ...
  let textTypeString;
  if (textTypeEnum !== "ROBOT_FRAMEWORK_BROWSER_NO_SET" /* ROBOT_FRAMEWORK_BROWSER_NO_SET */) {
...
var PlaywrightServer = class {
  ...
  async createCredential(call, callback) {
    try {
      const request = call.request;
      if (request === null) throw Error("No request");
      const result = await createCredential(request, this.getActiveContext(call));
      callback(null, result);
    } catch (e) {
      callback(errorResponse(e), null);
    }
  }
  async installCredential(call, callback) {
    try {
      const request = call.request;
      if (request === null) throw Error("No request");
      const result = await installCredential(this.getActiveContext(call));
      callback(null, result);
    } catch (e) {
      callback(errorResponse(e), null);
    }
  }
  async getCredential(call, callback) {
    try {
      const request = call.request;
      if (request === null) throw Error("No request");
      const result = await getCredential(request, this.getActiveContext(call));
      callback(null, result);
    } catch (e) {
      callback(errorResponse(e), null);
    }
  }
  async deleteCredential(call, callback) {
    try {
      const request = call.request;
      if (request === null) throw Error("No request");
      const result = await deleteCredential(request, this.getActiveContext(call));
      callback(null, result);
    } catch (e) {
      callback(errorResponse(e), null);
    }
