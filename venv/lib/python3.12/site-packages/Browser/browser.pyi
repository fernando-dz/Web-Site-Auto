...
from .keywords import Clock as Clock, Control as Control, Cookie as Cookie, Coverage as Coverage, Credential as Credential, Devices as Devices, Evaluation as Evaluation, Formatter as Formatter, Getters as Getters, Interaction as Interaction, LocatorHandler as LocatorHandler, Network as Network, Pdf as Pdf, PlaywrightState as PlaywrightState, Promises as Promises, RunOnFailureKeywords as RunOnFailureKeywords, StrictMode as StrictMode, Waiter as Waiter, WebAppState as WebAppState
from .keywords.crawling import Crawling as Crawling
from .playwright import Playwright as Playwright
from .utils import AutoClosingLevel as AutoClosingLevel, PlaywrightLogTypes as PlaywrightLogTypes, Scope as Scope, SettingsStack as SettingsStack, get_normalized_keyword as get_normalized_keyword, keyword as keyword, logger as logger, suppress_logging as suppress_logging
...
class Browser(DynamicCore):
    ...
    def create_credential(self, rpId: str, id_: str | None = None, privateKey: Secret | str | None = None, publicKey: Secret | str | None = None, userHandle: str | None = None): ...
    def install_credential(self) -> None: ...
    def get_credential(self, id_: str | None = None, rpId: str | None = None) -> ClientCredential: ...
    ...
    def show_keyword_banner(self, show: bool = True, style: str = '', scope: Scope = ...) -> dict[str, bool | str | None]: ...
    ...
    def set_presenter_mode(self, mode: HighLightElement | bool) -> HighLightElement | bool: ...
    ...
    def stop_coverage(self) -> Path | None: ...
    ...
    def get_aria_snapshot(self, selector: str, return_type: AriaSnapshotReturnType = ..., assertion_operator: AssertionOperator | None = None, assertion_expected: Any | None = None, message: str | None = None) -> str | dict | tuple: ...
    def get_url(self, assertion_operator: AssertionOperator | None = None, assertion_expected: Any | None = None, message: str | None = None) -> str | dict | tuple: ...
    def get_page_source(self, assertion_operator: AssertionOperator | None = None, assertion_expected: Any | None = None, message: str | None = None) -> str | dict | tuple: ...
    def get_title(self, assertion_operator: AssertionOperator | None = None, assertion_expected: Any | None = None, message: str | None = None) -> str | dict | tuple: ...
    def get_text(self, selector: str, assertion_operator: AssertionOperator | None = None, assertion_expected: Any | None = None, message: str | None = None, *, text_type: TextType | None = None) -> str | list[str] | dict | tuple: ...
    ...
    def get_attribute(self, selector: str, attribute: str, assertion_operator: AssertionOperator | None = None, assertion_expected: Any | None = None, message: str | None = None) -> str | tuple | dict | None: ...
    ...
    def get_viewport_size(self, key: SizeFields = ..., assertion_operator: AssertionOperator | None = None, assertion_expected: Any | None = None, message: str | tuple | dict | None = None) -> ViewportDimensions | None: ...
    ...
    def get_style(self, selector: str, key: str | None = 'ALL', assertion_operator: AssertionOperator | None = None, assertion_expected: Any | None = None, message: str | None = None, pseudo_element: str | None = None) -> dict[str, str] | str | tuple | dict: ...
    ...
    def type_secret(self, selector: str, secret: str | Secret, delay: timedelta = ..., clear: bool = True): ...
    ...
    def wait_for_alerts(self, actions: list[DialogAction], prompt_inputs: list[str | None], texts: list[str | None], timeout: timedelta | None = None) -> list[str]: ...
    ...
    def wait_for_request(self, matcher: str | RegExp = '', timeout: timedelta | None = None) -> DotDict | Any: ...
